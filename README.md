...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      I'm a <strong>Multimedia Engineering</strong> student from <strong>Cartagena, Colombia</strong>, passionate about building <strong>web applications</strong> and creating <strong>digital experiences</strong>. I work across <strong>frontend</strong> and <strong>backend</strong> development, and I also have a strong interest in <strong>3D art</strong> and <strong>animation</strong>.
    </td>
    <td>
